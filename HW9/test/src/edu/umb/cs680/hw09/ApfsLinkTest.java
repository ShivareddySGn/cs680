...
public class ApfsLinkTest {
	...
	@Test
	public void CheckLinkEqualityM() {
	...
	@Test
	public void CheckLinkEqualityN() {
	...
	@Test
	public void CheckifDirectoyTestingWithM() {
		assertFalse(m.isDirectory());
	}
	
	@Test
	public void CheckifFileTestingWithM() {
		assertFalse(m.isFile());
	}
	
	@Test
	public void CheckifLinkTestingWithM() {
		assertTrue(m.isLink());
	}
